...
For a fast dry-run without downloading model weights, set `ENABLE_MOCK_INFERENCE=1`. Optional `MOCK_BOX_COUNT` controls how many mock boxes are returned per image.
