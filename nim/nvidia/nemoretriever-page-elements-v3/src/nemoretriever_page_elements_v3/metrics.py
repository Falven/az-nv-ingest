...
def start_metrics_server(settings: ServiceSettings) -> None:
    """
    Start a standalone Prometheus metrics exporter when configured.

    Args:
        settings: Service settings controlling metrics exposure.
    """
...
def record_request(
    ...
    Args:
        ...
        status: Status label to associate with the request.
